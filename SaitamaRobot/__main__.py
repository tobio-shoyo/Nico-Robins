...
EREN_IMG = "https://te.legra.ph/file/f675f620b4cf26bf5a088.jpg"
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[Sen-pai!I am Alive now!](https://te.legra.ph/file/6f4fdd483e1b05e4557cd.jpg)", parse_mode=ParseMode.MARKDOWN)
        except Unauthorized:
            LOGGER.warning(
